...
To automate the creation of joint savings accounts, you will create a solidity smart contract that accepts two user
addresses that are then able to control a joint savings account. Your smart contract will use ether management 
functions to implement various requirements from the financial institution to provide the features of the joint 
savings account.
    ...
    */
    function withdraw(uint amount, address payable recipient) public {
        ...
        */
        ...
        /*
        Add an `if` statement to check if the `lastToWithdraw` is not equal to (`!=`) to `recipient` 
        ...
        */
        ...
        // Call the `contractBalance` variable and set it equal to the balance of the contract by using
        // `address(this).balance` to reflect the new balance of the contract.
        // YOUR CODE HERE!
